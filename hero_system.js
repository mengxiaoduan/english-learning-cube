...
(function () {
    ...
    var CSS = ''
        ...
        + '#m3-mon-bar{display:flex;align-items:center;gap:6px;width:100%;max-width:min(92vmin, calc(100vh - 240px), 620px);margin-top:2px;box-sizing:border-box;padding:0 6px;}'
        + '#m3-mon-emoji{font-size:1.25rem;line-height:1;transition:transform .3s;}'
        + '#m3-mon-track{flex:1;height:9px;background:rgba(0,0,0,.55);border:1px solid rgba(255,255,255,.22);border-radius:5px;overflow:hidden;}'
        ...
        + '#m3-mon-hp{font-size:.8rem;font-weight:900;color:#ff8a8a;min-width:2.6em;text-align:right;}'
        + '#m3-mon-coin{font-size:.72rem;font-weight:900;color:#ffd700;white-space:nowrap;}'
